...
var Level1 = {
	preload : function() {
		...
		game.load.image('starfield', 'public_assets/starfield.png');
		game.load.image('ship', 'public_assets//ship.png');
		game.load.image('bullet', 'public_assets//bullets/bullet.png');
