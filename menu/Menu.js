...
var Menu = {
	...
	preload: function() {
		// level thumbnail 
        game.load.image("levelthumb", "menu/assets/levelthumb.png");
        // level pages at the bottom
        game.load.image("levelpages", "menu/assets/levelpages.png");
        // transparent background used to scroll
        game.load.image("transp", "menu/assets/transp.png");
	},
             ...
             if(this.scrollingMap.startPosition == this.scrollingMap.x){
                  ...
                  for(i = 0; i < this.scrollingMap.children.length; i++){
                       ...
                       if(bounds.contains(pointer.x, pointer.y)){                    	                       	
                    	   game.state.start("Level" + this.scrollingMap.children[i].levelNumber);                     	   
                            break; 
                       }                  
                  }
             }
